...
function YoutubeHome() {
  ...
  return (
    <div
      className="min-h-screen bg-cover bg-center lg:pt-[10rem]"
      style={{
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen bg-black bg-opacity-50 lg:top-[-9rem]">
        {" "}
        <div className="absolute top-[6rem] md:top-[7rem] w-full max-w-xl">
          {" "}
          <div className=" bg-black shadow-lg">
            ...
            <div className="relative pb-[56.25%]">
              ...
              <iframe
                ...
                src="https://www.youtube.com/embed/1B6UQAjFJuE"
                frameBorder="0"
          ...
          <div className="absolute bottom-[-9rem] w-full flex justify-center ">
            <Link to={-1}>
              <button
