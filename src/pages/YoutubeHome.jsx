  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen bg-black bg-opacity-50 lg:top-[-9rem]">
        {" "}
        <div className="absolute top-[6rem] md:top-[7rem] w-full max-w-[26rem] md:max-w-xl">
          {" "}
          ...
          <div className="absolute bottom-[-7rem] md:bottom-[-9rem] w-full flex justify-center ">
            <Link to={-1}>
              <button
